        ...
        if (isSelector) {
            ...
            if (res && res.length) {
                ...
                promise.then((...args) => {
                    ...
                    let pResult = this.adaptor.processResponse(result[0], this, query, ajax.httpRequest, ajax); //modified for memory leak issue
                    let count = 0;
                    if (query.isCountRequired) {
                        count = pResult.count;
                    ...
                    let cResult = this.adaptor.processResponse(result[1], this, query.subQuery, ajax.httpRequest, ajax); //modified for memory leak issue
                    count = 0;
